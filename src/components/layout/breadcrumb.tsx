...
export function Breadcrumb(){
  return (
    <Link
      href="/"
      className="group relative inline-flex text-accent items-center gap-2 text-lg font-display uppercase tracking-wider mb-6 transition-all duration-300 hover:drop-shadow-accent hover:scale-105"
    >
