    ...
    <div className="section-py">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5 lg:gap-5">
        {features.map((f) => (
          ...
          >
            <AppIcon name={f.icon} className="h-12 w-12 max-lg:h-8 max-lg:w-8 text-accent" strokeWidth={1.5} />
            <span className="font-display font-bold uppercase text-lg max-lg:text-sm leading-snug text-text-primary">
              {f.title}
            </span>
