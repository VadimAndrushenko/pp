...
export function QuickNavCard({ icon: Icon, label, href }: QuickNavCardProps) {
  return (
    ...
    >
      <Icon
        className="w-8 h-8 text-accent transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-[0_0_8px_color-mix(in_srgb,var(--color-accent)_50%,transparent)]"
        strokeWidth={1.5}
      />
